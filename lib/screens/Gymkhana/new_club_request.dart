...
class _NewClubRequestState extends State<NewClubRequest> {
  ...
  String? _validateCoordinators() {
    if (_coordinatorController.text == _coCoordinatorController.text) {
      return 'Coordinator and Co-Coordinator cannot be the same';
    }
    return null;
  }
